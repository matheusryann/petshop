  ...
  return (
    <section className="bg-white py-16">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold mb-8" data-aos="fade-up" data-aos-delay="100">Nossos Serviços</h2>
        ...
        <div className="relative">
          ...
          <button
            className='bg-white flex items-center justify-center rounded-full shadow-lg w-10 h-10 absolute left-3 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10 hover:scale-105 transition-transform duration-300'
            onClick={scrollPrev}
          >
          ...
          <button
            className='bg-white flex items-center justify-center rounded-full shadow-lg w-10 h-10 absolute -right-6 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10 hover:scale-105 transition-transform duration-300'
            onClick={scrollNext}
          >
